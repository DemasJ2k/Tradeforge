"""
Strategy 41: BTCUSD RSI Micro Scalper
=======================================
Target: BTCUSD M5

Core idea: Ultra-fast RSI(2-3) bounce scalp on Bitcoin. Catches short-term
mean-reversion moves when RSI reaches extreme levels, filtered by a trend
EMA to trade only in the prevailing direction.
...
SETTINGS = [
    {"key": "rsi_period",     "label": "RSI Period",             "type": "int",   "default": 4,     "min": 2,     "max": 14,   "step": 1,    "group": "Indicator Settings", "description": "Ultra-short RSI lookback period for micro scalping"},
    {"key": "trend_ema",      "label": "Trend EMA Period",       "type": "int",   "default": 42,    "min": 10,    "max": 200,  "step": 1,    "group": "Indicator Settings", "description": "EMA period used as trend direction filter"},
    ...
    {"key": "rsi_os",         "label": "RSI Oversold Level",     "type": "int",   "default": 32,    "min": 5,     "max": 50,   "step": 1,    "group": "Entry Rules",        "description": "RSI must be below this level to trigger a long entry"},
    {"key": "rsi_ob",         "label": "RSI Overbought Level",   "type": "int",   "default": 68,    "min": 50,    "max": 95,   "step": 1,    "group": "Entry Rules",        "description": "RSI must be above this level to trigger a short entry"},
    ...
    {"key": "atr_tp_mult",    "label": "ATR Take-Profit Mult",   "type": "float", "default": 0.64,  "min": 0.25,  "max": 5.0,  "step": 0.05, "group": "Risk Management",    "description": "ATR multiplier for take-profit distance"},
