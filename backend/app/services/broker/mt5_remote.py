...
# SSL verification — set MT5_BRIDGE_VERIFY_SSL=false only for localhost/private networks
_VERIFY_SSL = os.getenv("MT5_BRIDGE_VERIFY_SSL", "true").lower() not in ("false", "0", "no")
