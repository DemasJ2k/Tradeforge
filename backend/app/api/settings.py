...
def _settings_to_response(s: UserSettings) -> SettingsResponse:
    ...
    return SettingsResponse(
        ...
        default_agent_type=getattr(s, "default_agent_type", "scalping") or "scalping",
        default_trading_mode=getattr(s, "default_trading_mode", "paper") or "paper",
        default_max_daily_loss=getattr(s, "default_max_daily_loss", "4.0") or "4.0",
        default_max_drawdown=getattr(s, "default_max_drawdown", "8.0") or "8.0",
        default_max_open_positions=getattr(s, "default_max_open_positions", "3") or "3",
