...
const PAGES = [
  ...
  { name: "Trading", href: "/trading", icon: TrendingUp, keywords: ["live", "positions", "broker", "orders", "agents"] },
  { name: "ML Lab", href: "/ml", icon: Brain, keywords: ["machine learning", "model", "train", "predict", "backtest"] },
